...
if __name__ == '__main__':
    ...
    fpcRun1 = loadParserList(os.path.join(samplePath, "run1/FINEGRAIN/"), "FPC")
    fpc2Run1 = loadParserList(os.path.join(samplePath, "run1/FPC2/FINEGRAIN/"), "FPC")
    fpc3Run1 = loadParserList(os.path.join(samplePath, "run1/FPC3/FINEGRAIN/"), "FPC")
    fpc4Run1 = loadParserList(os.path.join(samplePath, "run1/FPC4/FINEGRAIN/"), "FPC")
    fpc5Run1 = loadParserList(os.path.join(samplePath, "run1/FPC5/FINEGRAIN/"), "FPC")
    fpc6Run1 = loadParserList(os.path.join(samplePath, "run1/FPC6/FINEGRAIN/"), "FPC")
    fpc7Run1 = loadParserList(os.path.join(samplePath, "run1/FPC7/FINEGRAIN/"), "FPC")
    fpc8Run1 = loadParserList(os.path.join(samplePath, "run1/FPC8/FINEGRAIN/"), "FPC")

    fpcRun2 = loadParserList(os.path.join(samplePath, "run2/FINEGRAIN/"), "FPC")
    fpc2Run2 = loadParserList(os.path.join(samplePath, "run2/FPC2/FINEGRAIN/"), "FPC")
    fpc3Run2 = loadParserList(os.path.join(samplePath, "run2/FPC3/FINEGRAIN/"), "FPC")
    fpc4Run2 = loadParserList(os.path.join(samplePath, "run2/FPC4/FINEGRAIN/"), "FPC")
    fpc5Run2 = loadParserList(os.path.join(samplePath, "run2/FPC5/FINEGRAIN/"), "FPC")
    fpc6Run2 = loadParserList(os.path.join(samplePath, "run2/FPC6/FINEGRAIN/"), "FPC")
    fpc7Run2 = loadParserList(os.path.join(samplePath, "run2/FPC7/FINEGRAIN/"), "FPC")
    fpc8Run2 = loadParserList(os.path.join(samplePath, "run2/FPC8/FINEGRAIN/"), "FPC")

    fpcRun3 = loadParserList(os.path.join(samplePath, "run3/FINEGRAIN/"), "FPC")
    fpc2Run3 = loadParserList(os.path.join(samplePath, "run3/FPC2/FINEGRAIN/"), "FPC")
    fpc3Run3 = loadParserList(os.path.join(samplePath, "run3/FPC3/FINEGRAIN/"), "FPC")
    fpc4Run3 = loadParserList(os.path.join(samplePath, "run3/FPC4/FINEGRAIN/"), "FPC")
    fpc5Run3 = loadParserList(os.path.join(samplePath, "run3/FPC5/FINEGRAIN/"), "FPC")
    fpc6Run3 = loadParserList(os.path.join(samplePath, "run3/FPC6/FINEGRAIN/"), "FPC")
    fpc7Run3 = loadParserList(os.path.join(samplePath, "run3/FPC7/FINEGRAIN/"), "FPC")
    fpc8Run3 = loadParserList(os.path.join(samplePath, "run3/FPC8/FINEGRAIN/"), "FPC")

    gcRun1 = loadParserList(os.path.join(samplePath, "run1/GC"), "CleanDroid")
    gc2Run1 = loadParserList(os.path.join(samplePath, "run1/GC2/GC"), "CleanDroid")
    gc3Run1 = loadParserList(os.path.join(samplePath, "run1/GC3/GC"), "CleanDroid")
    gc4Run1 = loadParserList(os.path.join(samplePath, "run1/GC4/GC"), "CleanDroid")
    gc5Run1 = loadParserList(os.path.join(samplePath, "run1/GC5/GC"), "CleanDroid")
    gc6Run1 = loadParserList(os.path.join(samplePath, "run1/GC6/GC"), "CleanDroid")
    gc7Run1 = loadParserList(os.path.join(samplePath, "run1/GC7/GC"), "CleanDroid")
    gc8Run1 = loadParserList(os.path.join(samplePath, "run1/GC8/GC"), "CleanDroid")

    gcRun2 = loadParserList(os.path.join(samplePath, "run2/GC"), "CleanDroid")
    gc2Run2 = loadParserList(os.path.join(samplePath, "run2/GC2/GC"), "CleanDroid")
    gc3Run2 = loadParserList(os.path.join(samplePath, "run2/GC3/GC"), "CleanDroid")
    gc4Run2 = loadParserList(os.path.join(samplePath, "run2/GC4/GC"), "CleanDroid")
    gc5Run2 = loadParserList(os.path.join(samplePath, "run2/GC5/GC"), "CleanDroid")
    gc6Run2 = loadParserList(os.path.join(samplePath, "run2/GC6/GC"), "CleanDroid")
    gc7Run2 = loadParserList(os.path.join(samplePath, "run2/GC7/GC"), "CleanDroid")
    gc8Run2 = loadParserList(os.path.join(samplePath, "run2/GC8/GC"), "CleanDroid")

    gcRun3 = loadParserList(os.path.join(samplePath, "run3/GC"), "CleanDroid")
    gc2Run3 = loadParserList(os.path.join(samplePath, "run3/GC2/GC"), "CleanDroid")
    gc3Run3 = loadParserList(os.path.join(samplePath, "run3/GC3/GC"), "CleanDroid")
    gc4Run3 = loadParserList(os.path.join(samplePath, "run3/GC4/GC"), "CleanDroid")
    gc5Run3 = loadParserList(os.path.join(samplePath, "run3/GC5/GC"), "CleanDroid")
    gc6Run3 = loadParserList(os.path.join(samplePath, "run3/GC6/GC"), "CleanDroid")
    gc7Run3 = loadParserList(os.path.join(samplePath, "run3/GC7/GC"), "CleanDroid")
    gc8Run3 = loadParserList(os.path.join(samplePath, "run3/GC8/GC"), "CleanDroid")
