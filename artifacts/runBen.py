...
CLEANDROID2 = "./run.py -solver=GC -out=run6/GC2 -st=2"
CLEANDROID3 = "./run.py -solver=GC -out=run6/GC3 -st=3"
CLEANDROID4 = "./run.py -solver=GC -out=run6/GC4 -st=4"
CLEANDROID5 = "./run.py -solver=GC -out=run6/GC5 -st=5"
CLEANDROID6 = "./run.py -solver=GC -out=run6/GC6 -st=6"
CLEANDROID7 = "./run.py -solver=GC -out=run6/GC7 -st=7"
CLEANDROID8 = "./run.py -solver=GC -out=run6/GC8 -st=8"
